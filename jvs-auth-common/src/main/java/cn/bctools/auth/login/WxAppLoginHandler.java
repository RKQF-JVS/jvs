...
public class WxAppLoginHandler implements LoginHandler<WxAppDto> {
    ...
    public User handle(String code, String appId, WxAppDto wxAppDto) {
        ...
        UserExtension wxapp = new UserExtension().setType("wxapp").setOpenId(userInfo.getOpenid());
    ...
    public void bind(User user, String code, String appId) {
        ...
        UserExtension userExtension = userExtensionService.getOne(Wrappers.lambdaQuery(new UserExtension().setType("wxapp").setOpenId(userInfo.getOpenId())));
