...
public class Message implements Serializable {
    ...
    public List<PersonnelDto> getRecipientss(){
        if (ObjectNull.isNull(this.getRecipients())) {
            return new ArrayList<>();
        }
        return JSONObject.parseArray(JSONObject.toJSONString(this.getRecipients()), PersonnelDto.class);
    }
    /**
     * 发送内容
     */
