...
public class OssAutoConfiguration {
    ...
    public FileDataInterface FileDataInterface(SysFileMapper fileMapper) {
        return new FileDataInterface() {
            ...
            @Override
            public List<BaseFile> fileSize() {
                return fileMapper.selectSize(TenantContextHolder.getTenantId());
            }
            ...
            @Override
            public Page page(Page<OssFile> page, String fileName, String fileType, Long startTime, Long endTime, String bucketName, String label) {
                ...
                if (ObjectNull.isNull(label)) {
                    //如果标签为空， 则返回的数据一定是带有标签的
                    queryWrapper.isNotNull(OssFile::getLabel);
                }
